...
export const s = StyleSheet.create({
  ...
  quoteNumber: { fontFamily: 'Sohne', fontSize: FS.number, fontWeight: 'bold', color: C.ink, marginTop: 6 },
  ...
  custName: { fontFamily: 'Sohne', fontSize: FS.number, fontWeight: 'bold', color: C.ink, marginTop: 6 },
  ...
  lineName: { fontFamily: 'Sohne', fontSize: FS.title, fontWeight: 'bold', color: C.ink },
