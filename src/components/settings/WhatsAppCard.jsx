      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
        <div className="sm:col-span-2">
          ...
          <input id="wa-token" type="password" value={accessToken} onChange={(e) => setAccessToken(e.target.value)}
            placeholder={connectedAt ? '•••••••• (guardado)' : 'EAA…'} className="input mt-1" autoComplete="off" />
        </div>
        <div>
        ...
        <div className="sm:col-span-2">
          ...
          <input id="wa-secret" type="password" value={appSecret} onChange={(e) => setAppSecret(e.target.value)}
            placeholder={connectedAt ? '•••••••• (guardado)' : '32 caracteres hexadecimales'} className="input mt-1" autoComplete="off" />
